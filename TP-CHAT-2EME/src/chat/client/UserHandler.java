...
class UserHandler implements Runnable
{
	                   ...
	                   Logger parentLogger)
	{
		...
		if (in != null)
		{
			...
			/*
			 * DONE BufferedReader creation on InputStreamReader of the user
			 * input stream
			 */
		...
		if (out != null)
		{
			...
			/*
			 * DONE PrintWriter creation on server output stream
			 */
	...
	public void run()
	{
		...
		{
			/*
			 * DONE Read a line from the user with the userInBR.
			...
			{
				/*
				 * DONE Sends user input to server using the server print writer
				...
				/*
				 * COMPLETE check if user has typed the byeCmd from the Vocabulary
